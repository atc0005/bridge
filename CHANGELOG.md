...
- (GH-608) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.15 to go-ci-oldstable-build-v0.21.16 in /dependabot/docker/builds
- (GH-611) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.16 to go-ci-oldstable-build-v0.21.17 in /dependabot/docker/builds
- (GH-685) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.17 to go-ci-oldstable-build-v0.22.8 in /dependabot/docker/builds
- (GH-691) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.22.8 to go-ci-oldstable-build-v0.22.9 in /dependabot/docker/builds
- (GH-696) Disable Dependabot automatic PR rebasing
- (GH-668) Go Dependency: Bump golang.org/x/crypto from 0.29.0 to 0.36.0
- (GH-699) Go Dependency: Bump golang.org/x/crypto from 0.36.0 to 0.37.0
- (GH-684) Go Dependency: Bump golang.org/x/net from 0.31.0 to 0.38.0
- (GH-702) Go Dependency: Bump golang.org/x/net from 0.38.0 to 0.39.0
- (GH-670) Go Dependency: Bump golang.org/x/text from 0.20.0 to 0.23.0
- (GH-698) Go Dependency: Bump golang.org/x/text from 0.23.0 to 0.24.0
- (GH-687) Go Runtime: Bump golang from 1.22.10 to 1.23.8 in /dependabot/docker/go
- (GH-612) Go Runtime: Bump golang from 1.22.9 to 1.22.10 in /dependabot/docker/go
- (GH-677) go.mod: update minimum Go version to 1.23.0
- (GH-694) Update `xuri/efp` and `xuri/nfp` dependencies
- (GH-660) Update project to Go 1.23 series

### Fixed

- (GH-690) Fix invalid Dependabot go.mod changes
...
- (GH-536) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.4 to go-ci-oldstable-build-v0.21.5 in /dependabot/docker/builds
- (GH-539) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.5 to go-ci-oldstable-build-v0.21.6 in /dependabot/docker/builds
- (GH-540) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.6 to go-ci-oldstable-build-v0.21.7 in /dependabot/docker/builds
- (GH-551) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.7 to go-ci-oldstable-build-v0.21.8 in /dependabot/docker/builds
- (GH-556) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.8 to go-ci-oldstable-build-v0.21.9 in /dependabot/docker/builds
- (GH-544) Go Dependency: Bump golang.org/x/crypto from 0.25.0 to 0.26.0
- (GH-545) Go Dependency: Bump golang.org/x/net from 0.27.0 to 0.28.0
- (GH-546) Go Dependency: Bump golang.org/x/text from 0.16.0 to 0.17.0
- (GH-561) Go Runtime: Bump golang from 1.21.12 to 1.22.6 in /dependabot/docker/go
- (GH-558) Update project to Go 1.22 series

#### Other

- (GH-542) Push `REPO_VERSION` var into containers for builds

### Fixed

- (GH-560) Fix govet linting errors raised by updated linter
...
- (GH-512) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.7 to go-ci-oldstable-build-v0.20.8 in /dependabot/docker/builds
- (GH-516) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.8 to go-ci-oldstable-build-v0.21.2 in /dependabot/docker/builds
- (GH-519) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.2 to go-ci-oldstable-build-v0.21.3 in /dependabot/docker/builds
- (GH-522) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.21.3 to go-ci-oldstable-build-v0.21.4 in /dependabot/docker/builds
- (GH-526) Go Dependency: Bump golang.org/x/net from 0.26.0 to 0.27.0
- (GH-520) Go Runtime: Bump golang from 1.21.11 to 1.21.12 in /dependabot/docker/go
- (GH-530) Update `xuri/efp` and `xuri/nfp` dependencies
...
- (GH-492) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.4 to go-ci-oldstable-build-v0.20.5 in /dependabot/docker/builds
- (GH-494) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.5 to go-ci-oldstable-build-v0.20.6 in /dependabot/docker/builds
- (GH-506) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.6 to go-ci-oldstable-build-v0.20.7 in /dependabot/docker/builds
- (GH-502) Go Dependency: Bump golang.org/x/crypto from 0.23.0 to 0.24.0
- (GH-501) Go Dependency: Bump golang.org/x/net from 0.25.0 to 0.26.0
- (GH-503) Go Dependency: Bump golang.org/x/text from 0.15.0 to 0.16.0
- (GH-505) Go Runtime: Bump golang from 1.21.10 to 1.21.11 in /dependabot/docker/go

### Fixed

- (GH-495) Remove inactive maligned linter
- (GH-496) Fix errcheck linting errors
...
- (GH-477) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.1 to go-ci-oldstable-build-v0.20.2 in /dependabot/docker/builds
- (GH-485) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.2 to go-ci-oldstable-build-v0.20.3 in /dependabot/docker/builds
- (GH-486) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.3 to go-ci-oldstable-build-v0.20.4 in /dependabot/docker/builds
- (GH-479) Go Dependency: Bump golang.org/x/crypto from 0.22.0 to 0.23.0
- (GH-478) Go Dependency: Bump golang.org/x/net from 0.24.0 to 0.25.0
- (GH-474) Go Dependency: Bump golang.org/x/text from 0.14.0 to 0.15.0
- (GH-482) Go Runtime: Bump golang from 1.21.9 to 1.21.10 in /dependabot/docker/go
...
- (GH-454) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.15.4 to go-ci-oldstable-build-v0.16.0 in /dependabot/docker/builds
- (GH-456) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.16.0 to go-ci-oldstable-build-v0.16.1 in /dependabot/docker/builds
- (GH-457) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.16.1 to go-ci-oldstable-build-v0.19.0 in /dependabot/docker/builds
- (GH-460) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.19.0 to go-ci-oldstable-build-v0.20.0 in /dependabot/docker/builds
- (GH-470) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.0 to go-ci-oldstable-build-v0.20.1 in /dependabot/docker/builds
- (GH-465) Go Dependency: Bump golang.org/x/crypto from 0.21.0 to 0.22.0
- (GH-466) Go Dependency: Bump golang.org/x/net from 0.22.0 to 0.24.0
- (GH-462) Go Runtime: Bump golang from 1.21.8 to 1.21.9 in /dependabot/docker/go
...
- (GH-416) canary: bump golang from 1.20.13 to 1.20.14 in /dependabot/docker/go
- (GH-402) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.3 to go-ci-oldstable-build-v0.14.4 in /dependabot/docker/builds
- (GH-406) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.4 to go-ci-oldstable-build-v0.14.5 in /dependabot/docker/builds
- (GH-409) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.5 to go-ci-oldstable-build-v0.14.6 in /dependabot/docker/builds
- (GH-422) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.6 to go-ci-oldstable-build-v0.14.9 in /dependabot/docker/builds
- (GH-424) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.9 to go-ci-oldstable-build-v0.15.0 in /dependabot/docker/builds
- (GH-420) go.mod: bump golang.org/x/crypto from 0.18.0 to 0.19.0
- (GH-419) go.mod: bump golang.org/x/net from 0.20.0 to 0.21.0
...
[v0.5.8]: https://github.com/atc0005/bridge/releases/tag/v0.5.8
[v0.5.7]: https://github.com/atc0005/bridge/releases/tag/v0.5.7
